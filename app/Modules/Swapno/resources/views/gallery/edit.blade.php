                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            {!! Form::model($data, ['method' => 'PATCH','autocomplete'=>'off', 'files'=> true, 'route'=> ['admin.gallery.update', $data->id],"class"=>"",'enctype'=>'multipart/form-data', 'id' => 'basic-form']) !!}

                            @include('Swapno::gallery._form')
