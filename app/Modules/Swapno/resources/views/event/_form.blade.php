        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group row mg-top">
                    ...
                    <div class="col-sm-9">
                        {!! Form::textarea('description',old('description'),['id'=>'description','class' => 'form-control','Placeholder' => 'Enter description','rows'=>2]) !!}
                ...
                <div class="form-group row mg-top">
                    <div class="col-sm-3">
                        {!! Form::label('date', 'Event Date', array('class' => 'form-label')) !!}
                        <span style="color: red">*</span>
                    </div>

                    <div class="col-sm-9">
                        {!! Form::date('event_date',old('event_date'),['id'=>'event_date','class' => 'form-control']) !!}
                        <span style="color: #ff0000">{!! $errors->first('event_date') !!}</span>
                    </div>
                </div>
